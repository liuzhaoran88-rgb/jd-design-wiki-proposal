...
跨 skill 共享的真相源(level 词表 / 7 章节 anchor slug / Relay sharedPluginData namespace)。
...
| 文件 | 谁消费 | 作用 |
|---|---|---|
| [level-vocab.md](./level-vocab.md) | relay-to-design-md(写)/ design-md-to-site(分组)/ design-md-to-spec-page(过滤) | `level` frontmatter 枚举词表 + 与 `bg` 的边界 |
| [section-anchors.md](./section-anchors.md) | design-md-to-site(总站锚)/ design-md-to-spec-page(详情页章节) | 7 章节 canonical name + slug,锚跳锁死 |
